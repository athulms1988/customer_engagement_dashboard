( function ( $ ) {
    ...
    function showCampaignSection(label) {
        $("[data-toggle=popover]").popover({
            html: true,
            placement:"left",
            content:'<div class="card-body"><div class=""><h5>Campaign</h5><ul class="campaign_list"> <li class="campaign_list_active"><div class="checkbox"><input type="checkbox" id="loyalty_campaign"> <label for="loyalty_campaign">Loyalty Campaign</label></div></li> <li class="campaign_list_active"> <div class="checkbox"><input type="checkbox" id="feedback">  <label for="feedback">Feedback</label></div> </li><li class="campaign_list_active"> <div class="checkbox"><input type="checkbox" id="anniversary"> <label for="anniversary">Anniversary</label></div> </li><li class="campaign_list_active"><div class="checkbox"> <input type="checkbox" id="business">  <label for="business">Business Update</label></div></li></ul> </div><div> <h5>Channels</h5><div><ul class="channel__list"><li><div class="checkbox"><input type="checkbox" id="email"> <label for="email">Email</label></div></li><li><div class="checkbox"><input type="checkbox" id="whatsapp"> <label for="whatsapp">Social Media</label></div></li><li><div class="checkbox"><input type="checkbox" id="webpush"> <label for="webpush">Web Notification</label></div></li><li><div class="checkbox"><input type="checkbox" id="sms"> <label for="sms">SMS</label></div></li></ul></div></div><div class="pull-right"><button type="button" class="btn-primary btn-submit" onclick="window.submitCampaign()">Submit</button></div></div>'
        });
    }
